...
**✖️ Radix-4 Booth Multiplier** *(SoC Design)*
<br>
High-performance signed multiplier implemented in Verilog targeting Zynq UltraScale+ FPGA. Optimized for competitive Area × Latency metric with Booth encoding for reduced partial products.

`Verilog` `Vivado` `FPGA` `Digital Design`
